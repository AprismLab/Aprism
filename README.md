...
> Author: BlockConnect@StarsailsClover | Version: v26.0-Alpha.2 (Phase0 internal)
...
- Example artifact: `Aprism-v26.0-Alpha.2-JE-26.2.jar`
- Beta is not planned.
...
```bash
java -javaagent:Aprism-v26.0-Alpha.2-JE-26.2.jar=aprismVersion=v26.0-Alpha.2;mcEdit=JE;mcVersion=26.2;gameRoot=<path-to-game-dir> ...
```
