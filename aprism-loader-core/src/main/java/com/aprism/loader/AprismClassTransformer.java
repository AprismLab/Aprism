 ...
 *   <li><b>Access wideners</b>: ASM read/write pass that serves as the
 *       access-widener application point (currently a structural no-op; real
 *       widener rules will be wired in a subsequent task).</li>
 * </ol>
 *
